            ...
            <section className="hero">
                ...
                <div className="hero-content">
                    ...
                    <h1 className="hero-name">
                        안녕하세요,
                        <br />
                        <span className="hero-name-highlight">안현석</span>
                        입니다.
                    </h1>
                    <p className="hero-title">
                        <strong>Frontend Developer</strong> — 사용자 경험을
                        최우선으로 생각합니다
                    </p>
                    <p className="hero-desc">
                        React, PWA 기반 웹 앱 개발 경험을 보유하고 있으며, 실무
                        DB & 서버 관리, 보안 인증 시스템, AI API 연동, AWS
                        서버리스 배포까지 폭넓게 경험했습니다. 채용 담당자분의
                        연락을 언제나 환영합니다.
                    </p>
                ...
                <div className="container">
                    <div className="home-about-grid">
                        <div className="home-about-text">
                            ...
                            <p className="reveal">
                                정보처리기사, SQLD, ADsP 등 다수의 자격증을
                                보유하고 있으며, 실무에서는 대구경북 교통카드
                                시스템 유지보수와 LG SHOPTIME 서비스 페이지 개발
                                경험이 있습니다.
                            </p>
                            <p
                                ...
                                style={{ marginTop: 12 }}
                            >
                                삼성청년SW·AI아카데미(SSAFY) 교육 과정을 통해
                                Vue, Spring, AI 기반의 팀 프로젝트에서
                                프론트엔드 개발을 주도하며, 보안 기능 설계부터
                                AWS 배포까지 전체 사이클을 경험했습니다.
                            </p>
                            <div
                        ...
                        <div className="about-stats">
                            {[
                                ...
                                <div
                                    key={i}
                                    className={`stat-card reveal reveal-delay-${i}`}
                                >
                ...
                <div className="container">
                    ...
                    <div className="skills-quick-grid">
                        {skillChips.map((s, i) => (
                            <div
                                key={s.name}
                                className={`skill-chip reveal reveal-delay-${Math.min(i % 5, 4)}`}
                            >
                            ...
                            >
                                ...
                                <div className="card-body">
                                    <div className="card-tags">
                                        <span
                                            className={`tag tag-${project.type}`}
                                        >
                                            {project.typeLabel}
                                        </span>
                                        {project.teamSize && (
                                            <span className="tag tag-accent">
                                                팀 {project.teamSize}인
                                            </span>
                                        )}
                                    </div>
