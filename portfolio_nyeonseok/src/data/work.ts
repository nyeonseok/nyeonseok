...
export const workProjects: WorkProject[] = [
  {
    ...
    techStack: ['WebtoB', 'JEUS', 'Tibero', 'Tibero Studio', 'DataGrip', 'SG Client', 'CHAKRA', 'Spring Boot'],
    responsibilities: [
    ...
    achievements: [
      ...
      {
        title: '이상 접근자 모니터링',
        description: '서비스 이상 접근자를 모니터링·문서화해 차단하고 이해관계자에게 현황 전파',
      },
      {
        title: '서비스 민원 감소',
        description: '로그 분석 기반 배치 오류 원인 파악 및 체계적인 오류 대응으로 서비스 안정화',
        metric: '민원 약 70% 감소',
      },
      {
        title: '교통카드 이용 증가',
