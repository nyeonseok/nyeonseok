import tripBatonImg from "../assets/Trip_Baton/tripbaton.png";
import veroImg from "../assets/Vero/vero.webp";
import ilkanImg from "../assets/ILKAN/ilkan.webp";
import menuPickerImg from "../assets/Menu_Picker/menupicker.webp";
import stageOnImg from "../assets/Stage_On/stageon.webp";

import tripVideo from "../assets/Trip_Baton/서비스 시연 영상.mp4";

import trip1 from "../assets/Trip_Baton/main.png";
import trip2 from "../assets/Trip_Baton/relay.png";
import trip3 from "../assets/Trip_Baton/relay_detail.png";

import vero1 from "../assets/Vero/main.png";
import vero2 from "../assets/Vero/ai_select.png";
import vero3 from "../assets/Vero/chat.png";

import ilkan1 from "../assets/ILKAN/main.png";
import ilkan2 from "../assets/ILKAN/reservation.png";
import ilkan3 from "../assets/ILKAN/remodeling.png";

import mp1 from "../assets/Menu_Picker/main.png";
import mp2 from "../assets/Menu_Picker/search.png";
import mp3 from "../assets/Menu_Picker/result.png";

import stage1 from "../assets/Stage_On/main.png";
import stage2 from "../assets/Stage_On/search.png";
import stage3 from "../assets/Stage_On/concert.png";
...
export const projects: Project[] = [
  {
    ...
    background:
      "SSAFY 1학기 최종 관통 프로젝트로 진행되었습니다. 여행을 할 때 재밌게 참여할 수 있도록 릴레이 컨셉으로 기획했으며, 생성형 AI로 여행지 추천, 여행지 설명을 제공하고 배치 작업으로 데이터를 주기적으로 갱신하도록 설계했습니다. 웹과 모바일 환경을 하나의 코드베이스에서 모두 만족시키기 위해 FSD(Feature-Sliced Design) 아키텍처를 도입하고, PWA로 제작해 앱 스토어 배포 없이도 모바일에서 네이티브에 가까운 경험을 제공하는 것을 목표로 했습니다.",
    techReason:
    ...
    thumbnail: tripBatonImg,
    featured: true,
    features: [
      {
        title: "릴레이 경로 지도에 표시",
        description:
          "다른 사용자들이 릴레이에 참여한 지역들을 지도에 선으로 연결하여 시각화",
      },
      {
        title: "소셜 로그인",
        description: "OAuth(카카오·구글) 기반 로그인, JWT 인증/인가",
      },
      {
        title: "생성형 AI 연동",
        description:
      ...
      {
        title: "이미지 업로드",
        description: "Presigned URL로 클라이언트가 S3에 직접 업로드",
      },
      {
        title: "배치",
      ...
      {
        title: "검색",
        description: "debounce 적용, 컴포넌트화하여 모든 검색창에서 재사용",
      },
      {
        title: "PWA",
    ...
    contributions: [
      ...
      {
        title: "백엔드 · 배치",
        items: ["백엔드 로직 일부 구현, 일정 주기로 동작하는 배치 기능 구현"],
      },
      {
        title: "일정 관리",
    ...
    screenshots: [
      {
        image: trip1,
        title: "메인 화면",
        description: "Trip Baton을 시작하는 메인 화면, QR 코드로 앱 설치 가능",
      },
      {
        image: trip2,
        title: "릴레이 경로",
        description:
          "릴레이에 포함된 지역 지도에 선으로 연결하여 시각화, 모달창엔 AI 지역 설명 표시",
      },
      {
        image: trip3,
        title: "릴레이 상세",
        description:
          "릴레이의 세부 정보 표시, 지나온 지역과 AI 추천 여행지 확인 가능",
      },
    ],
    github: "https://github.com/SSAFY-TRIP-AL",
    demoVideo: tripVideo,
    demo: "https://tripbaton.vercel.app/",
  },
  {
    id: "vero",
    title: "VERO",
    ...
    features: [
      ...
      {
        title: "아이디/비밀번호 찾기",
        description: "핸드폰 인증 기반 아이디 전송, 임시 비밀번호 이메일 발송",
      },
      {
        title: "마이 페이지",
        description:
...
const lambda = new aws.lambda.Function("lambdaFunction", {
    ...
    screenshots: [
      {
        image: vero1,
        title: "메인 화면",
        description: "vero를 시작하는 메인 화면",
      },
      {
        image: vero2,
        title: "AI 선택 화면",
        description:
          "Gemini, Claude, ChatGPT 중 원하는 AI를 선택하여 대화 시작",
      },
      {
        image: vero3,
        title: "LLM 대화 화면",
        description:
          "검열 AI를 거쳐 LLM과 안전하게 대화, 이전 대화 기록 확인 가능, 보안에 위배되는 질문 시 검열 AI가 질문 차단",
      },
    ],
  ...
  },
  {
    ...
    features: [
      ...
      {
        title: "AI 리모델링",
        description: "공실 사진 업로드 + 방향성 입력 → GPT API로 이미지 변환",
      },
    ],
    contributions: [
      {
...
/>`,
    ...
    screenshots: [
      {
        ...
        title: "메인 화면",
        description:
          "사용자 role에 따라 다른 메인 화면 렌더링 (전문가/건물주/의뢰자)",
      },
      {
        image: ilkan2,
        title: "공실 예약 화면",
        description:
          "공실 예약 시 이용 가능한 날짜 표시 및 공실 설명 확인 가능, 예약 후 마이 페이지에서 진행 현황 확인 가능",
      },
      {
        image: ilkan3,
        title: "AI 리모델링 화면",
        description:
          "공실 사진 업로드 + 방향성 입력 → openAI API로 이미지 변환, 변환된 이미지를 마이 페이지에서 확인 가능",
      },
    ],
  ...
  },
  {
    ...
    features: [
      ...
      {
        title: "Gemini AI",
        description: "Vercel 서버리스 함수를 통한 Gemini API 호출 (CORS 우회)",
      },
      {
        title: "결과 표시",
        description:
    ...
    screenshots: [
      {
        image: mp1,
        title: "메인 화면",
        description: "Menu Picker를 시작하는 메인 화면, QR 코드로 앱 설치 가능",
      },
      {
        image: mp2,
        title: "위치 검색 화면",
        description:
          "검색창에 위치 검색, GPS 기반 현재 위치 불러오기, debounce 적용으로 불필요한 API 호출 최소화",
      },
      {
        image: mp3,
        title: "추천 결과 화면",
        description: "추천된 음식점을 표시, 카카오맵 연동으로 위치 확인 가능",
      },
    ],
  ...
  },
  {
    ...
    features: [
      ...
      {
        title: "검색",
        description: "최근 검색 5개, 추천 검색어 5개, 공연/밴드 탭 구분",
      },
      {
        title: "타임테이블",
      ...
      {
        title: "PWA",
        description: "모바일 앱처럼 설치 가능, dvh 단위 안정적 뷰포트 처리",
      },
    ],
    contributions: [
      {
    ...
    screenshots: [
      {
        ...
        title: "메인 화면",
        description:
          "내가 선호하는 아티스트의 공연 일정을 한눈에 확인할 수 있습니다.",
      },
      {
        image: stage2,
        title: "공연 검색 화면",
        description: "공연과 아티스트를 통합 검색할 수 있습니다.",
      },
      {
        image: stage3,
        title: "MY BANDS",
        description: "관심 아티스트를 등록하고 관리할 수 있습니다.",
      },
    ],
